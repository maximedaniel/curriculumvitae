...
![Double Diamond Model](img/design-methods/double-diamond.jpg){#doublediamond-container width="80%"} 
...
![SCAMPER Method](img/design-methods/scamper.jpg){#scamper-container width="90%"}
...
# Interaction Design Methods
 ...
 - 2. What are the potential benefits of adding these new properties/features to the system for the users?
 ...
 - 3. What technical evaluation or user study can you do to validate and measure the benefits of these new properties/features?
    ????
...
8. **Key Partners**: Identifies the external organizations or partners that help the business achieve its objectives.
9. **Cost Structure**: Outlines the major costs and expenses associated with running the business.

![Business Model Canvas](img/design-methods/business-canvas.png){#businessmodelcanvas-container width="100%"} -->
